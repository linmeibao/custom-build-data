...
public class SerializeExampleConfig {
    ...
    public void generate() {
        ...
        try {
            ...
            for (Map.Entry<String, Connection> entry : connectionMap.entrySet()) {
                ...
                DatabaseMetaData dataMetaData = connection.getMetaData();
                String databaseName = dataMetaData.getUserName();

                List<String> tableList = findAllTableNameList(connection, databaseName);
                List<TableInfo> tempTableInfos = convertTableInfos(entry.getKey(), connection, databaseName, tableList);
            ...
            if (generateDMl) {
                ...
                FileUtils.writeStringToFile(new File(generateExampleFilePath + "example.json"), JSONObject.toJSONString(tempList));
            }
        } catch (Exception e) {
    ...
    private List<TableInfo> convertTableInfos(String dbKey, Connection connection, String databaseName, List<String> tableList) {
        ...
        try {
            ...
            for (Map<String, String> map : resultList) {
                ...
                for (TableInfo tableInfo : tableInfos) {
                    if (tableInfo.getTableName().equals(tableName)) {
                        ...
                        tableColumn.setIsNullStr(isNullAble);
            ...
            for (String tableName : tableList) {
                ...
                preparedStatement = connection.prepareStatement("show index from ?");
     ...
     * @return
     */
    private List<String> findAllTableNameList(Connection connection, String databaseName) {
